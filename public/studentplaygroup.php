...
echo "<p> <a href='uploads/playgroup/".$row['syllabus_photo']."' target='_blank'>Click here</a> to view syllabus in photo</p>";
}
if($row['syllabus_file']!=null){
if($row['syllabus_file']!=null && $row['syllabus_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/playgroup/".$row['syllabus_file']."' target='_blank'>Click here</a> to view syllabus in pdf/word</p>";
}
...
echo "<p> <a href='uploads/playgroup/".$row['course_photo']."' target='_blank'>Click here</a> to view course in photo</p>";
}
if($row['course_file']!=null){
if($row['course_file']!=null && $row['course_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/playgroup/".$row['course_file']."' target='_blank'>Click here</a> to view course in pdf/word</p>";
}
...
echo "<p> <a href='uploads/playgroup/".$row['samplepaper_photo']."' target='_blank'>Click here</a> to view sample paper in photo</p>";
}
if($row['samplepaper_file']!=null){
if($row['samplepaper_file']!=null && $row['samplepaper_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/playgroup/".$row['samplepaper_file']."' target='_blank'>Click here</a> to view sample paper in pdf/word</p>";
}
...
echo "<p> <a href='uploads/playgroup/".$row['datesheet_photo']."' target='_blank'>Click here</a> to view datesheet in photo</p>";
}
if($row['datesheet_file']!=null){
if($row['datesheet_file']!=null && $row['datesheet_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/playgroup/".$row['datesheet_file']."' target='_blank'>Click here</a> to view datesheet in pdf/word</p>";
}
