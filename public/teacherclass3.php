...
if (isset($_POST['datesheet_photo'])){
	...
	move_uploaded_file($_FILES["datesheet_photo"]["tmp_name"],'uploads/class3/'.$picname);
$query="update class_content set datesheet_photo='$picname' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
alert('Photo added successfully');
location='teacherclass3.php';
</script>";	
 ...
 if (isset($_POST['datesheet_file'])){
	...
	move_uploaded_file($_FILES["datesheet_file"]["tmp_name"],'uploads/class3/'.$filename);
$query="update class_content set datesheet_file='$filename' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
if (isset($_POST['samplepaper_photo'])){
	...
	move_uploaded_file($_FILES["samplepaper_photo"]["tmp_name"],'uploads/class3/'.$picname);
$query="update class_content set samplepaper_photo='$picname' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
location='teacherclass3.php';
 ...
 if (isset($_POST['samplepaper_file'])){
	...
	move_uploaded_file($_FILES["samplepaper_file"]["tmp_name"],'uploads/class3/'.$filename);
$query="update class_content set samplepaper_file='$filename' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
if (isset($_POST['course_photo'])){
	...
	move_uploaded_file($_FILES["course_photo"]["tmp_name"],'uploads/class3/'.$picname);
$query="update class_content set course_photo='$picname' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
location='teacherclass3.php';
 ...
 if (isset($_POST['course_file'])){
	...
	move_uploaded_file($_FILES["course_file"]["tmp_name"],'uploads/class3/'.$filename);
$query="update class_content set course_file='$filename' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
if (isset($_POST['syllabus_photo'])){
	...
	move_uploaded_file($_FILES["syllabus_photo"]["tmp_name"],'uploads/class3/'.$picname);
$query="update class_content set syllabus_photo='$picname' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
location='teacherclass3.php';
 ...
 if (isset($_POST['syllabus_file'])){
	...
	move_uploaded_file($_FILES["syllabus_file"]["tmp_name"],'uploads/class3/'.$filename);
$query="update class_content set syllabus_file='$filename' where class='class3'";
$check=mysqli_query($conn,$query);
if($check==true)
{
echo "<script type='text/javascript'>
...
echo "<p> <a href='uploads/class3/".$row['syllabus_photo']."' target='_blank'>Click here</a> to view syllabus in photo <a href='deletesyllabusphoto.php?class=class3&photo=syllabus_photo'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
if($row['syllabus_file']!=null){
if($row['syllabus_file']!=null && $row['syllabus_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/class3/".$row['syllabus_file']."' target='_blank'>Click here</a> to view syllabus in pdf/word <a href='deletesyllabusfile.php?class=class3&file=syllabus_file'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
...
echo "<p> <a href='uploads/class3/".$row['course_photo']."' target='_blank'>Click here</a> to view course in photo  <a href='deletesyllabusphoto.php?class=class3&photo=course_photo'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
if($row['course_file']!=null){
if($row['course_file']!=null && $row['course_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/class3/".$row['course_file']."' target='_blank'>Click here</a> to view course in pdf/word  <a href='deletesyllabusfile.php?class=class3&file=course_file'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
...
echo "<p> <a href='uploads/class3/".$row['samplepaper_photo']."' target='_blank'>Click here</a> to view sample paper in photo  <a href='deletesyllabusphoto.php?class=class3&photo=samplepaper_photo'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
if($row['samplepaper_file']!=null){
if($row['samplepaper_file']!=null && $row['samplepaper_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/class3/".$row['samplepaper_file']."' target='_blank'>Click here</a> to view sample paper in pdf/word  <a href='deletesyllabusfile.php?class=class3&file=samplepaper_file'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
...
echo "<p> <a href='uploads/class3/".$row['datesheet_photo']."' target='_blank'>Click here</a> to view datesheet in photo  <a href='deletesyllabusphoto.php?class=class3&photo=datesheet_photo'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
if($row['datesheet_file']!=null){
if($row['datesheet_file']!=null && $row['datesheet_photo']!=null) echo "<p>OR</p>";
echo "<p> <a href='uploads/class3/".$row['datesheet_file']."' target='_blank'>Click here</a> to view datesheet in pdf/word  <a href='deletesyllabusfile.php?class=class3&file=datesheet_file'><img src='../Admin/uploads/delete.png' alt='picture not found'  /></a></p>";
}
